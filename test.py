...
parser.add_argument('--model_name', type=str,
                    default="e", help='the name of network')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            ...
            "checkpoint_path" : './pth/{}_e_{}_{}_{}/epoch_499.pth'.format(args.model_name, args.base_lr,
        ...
        'ACDC': {
            ...
            "checkpoint_path" : './pth/{}_ACDC_{}_{}_{}/epoch_399.pth'.format(args.model_name, args.base_lr,
                                                                              args.max_epochs, args.dataset),
